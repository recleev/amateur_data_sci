...
$$
y = \frac{2A_{\triangle}}{x} \tag{a} \label{y1}
$$
...
The solution $x = \frac{1}{2}a$ is not a possible because it results to a denaminator of $0$, so the the minimum area is achieved when $x = \frac{2}{3}a$.
