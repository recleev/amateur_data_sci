...
$$
\begin{equation}
A_{\triangle} = \frac{1}{2} \lvert \sum_{i = 1}^n x_i (y_{i + 1} - y_{i - 1}) \rvert \tag{The Shoelace Formula} \label{shoelace}
\end{equation}
$$
...
\\
\\
A_{\triangle} &= \frac{1}{2}ay - \frac{1}{2}xy + \frac{1}{2}\sqrt{2ax - a^2}
\end{align}
$$
...
The key to proceed with this problem is to realize that the area of $\triangle ABC$ is the same as the area of the right triangle indicated by the dashed lines in the figure, i.e. $A_{\triangle} = \frac{1}{2}xy$. This also gives us $y$ as a function of $x$ and the $A_{\triangle}$, $y = 2A_{\triangle}/x$.
