...
position of the variable secant as $Q$ slides along the curve toward $P$. --- @cwag_2016 [restating](testing citations with .bib; does not seem too complicated; might use this more often) Fermat's definition of a tangent line
