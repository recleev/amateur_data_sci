...
I had to revisit the annuity equation:
...
*Note: The equation above has the assumption that annuity starts at the end of year one, like the case in this investment simulation, and the future value is at a year after the nth year, not like this simulation. This investment simulation takes the future value at the end of the nth year, so the last annuity does not gain interest. For my simulation and the equation above to be consistent, find the future value using the interest at any year n, then pull back an interest* ($FV / (1+ i)$).
...
The interests estimated here are the equivalent growth rate of the investment at certain years. Given the current portfolio value, the annual `r peso(12000)` investment after n years will have an equivalent of i growth / decay rate.
