...
$FV$ is the future value or the money we have after a certain period, $A$ is the annuity or the regular payment per period, $i$ is the interest rate, and $n$ is the number of interest periods. The equation is easy to use when we want to find $FV$, $A$, or $n$. Finding $i$ needs a bit of iteration. 
