...
compute_interest_rate_annuity <- function(
  ...
  interest_rate <- (future_value / annuity)^(1/period_annuity) - 1
  
  while (
    (annuity * ((1 + interest_rate) ^ period_annuity - 1) / interest_rate) < future_value
  ) {
    interest_rate <- interest_rate + 0.0000001
  }
