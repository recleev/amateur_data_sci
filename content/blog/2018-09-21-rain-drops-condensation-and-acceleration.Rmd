...
$$
\begin{align}
\frac{d}{dr} \left( r^3 v \right) &= \left( \frac{\delta}{c} \right) r^3 g \tag{2} \label{hint}
\\
\\
...
Keeping in mind that $m$, $r$, and $v$ all vary with time and all other values are constant, I expanded $\eqref{momentum-rate}$ both from itself and by using $\eqref{volume-density}$. By the [product rule](https://amateurdatasci.rbind.io/blog/deriving-quotient-rule-product-rule/),
...
Substituting $\eqref{mass-rate}$ and $\eqref{volume-density}$ again,
