...
$$
\begin{equation}
F = \frac{d \left( mv \right)}{dt} \label{momentum-rate}
\end{equation}
$$
...
$$
\begin{equation}
\frac{dm}{dt} = 4 \pi r^2 c \label{mass-rate}
\end{equation}
$$
...
$$
\begin{equation}
m = \frac{4}{3} \pi r^3 \delta \label{volume-density}
\end{equation}
$$
...
\\
\\
dt &= \frac{\delta}{c} dr \label{radius-time}
\end{align}
$$
...
\\
\\
\frac{d}{dr} \left( r^3 v \right) &= \frac{\delta}{c} r^3 g \label{hint-proof}
\end{align}
$$
...
\\
\\
v &= \frac{\delta g r}{4c} \label{velocity-radius}
\end{align}
$$
