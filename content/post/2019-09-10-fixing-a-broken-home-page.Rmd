...
I write this blog using [`{blogdown}`] and the [Hugo](https://gohugo.io/) theme [blackburn](https://themes.gohugo.io/blackburn/). For now, I can say my skill is limited to `R`, so I can handle mostly anything `{blogdown}`-related. I don't know Hugo and html.
...
That solved my problem. However, as I am not a Hugo expert, I am not sure if what I did will not break anything. I filed an [issue](https://github.com/yoshiharuyamashita/blackburn/issues/93) to make the problem known and make blackburn compatible with the current, and hopefully future, versions of Hugo. I also hope this can help my fellow blackburn users not that versed with Hugo.