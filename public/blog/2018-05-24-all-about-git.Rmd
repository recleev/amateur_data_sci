...
![Sign Up in Github](/img/2018-05-24-all-about-git-files/github-sign-up.jpg)

## Once we have an account, we can immediately create a repository.

Go to profile. Select the Repositories tab. Click New.

![Create New Repository](/img/2018-05-24-all-about-git-files/new-repo.jpg)
![Create New Repository](/static/2018-05-24-all-about-git-files/new-repo.jpg)

You should get to this page.

![New Repository Form](/img/2018-05-24-all-about-git-files/new-repo-form.jpg)
...
![Create Project with Git in R Studio](/img/2018-05-24-all-about-git-files/project-version-control.jpg)

Choose Git. I have not used SVN yet.

![Choose Git](/img/2018-05-24-all-about-git-files/choose-git.jpg)

## Copy Repository URL and Create Project

Go back to the empty repository and copy the repository URL.

![Repository URL](/img/2018-05-24-all-about-git-files/repo-url.jpg)
...
![Project with .gitignore](/img/2018-05-24-all-about-git-files/project-with-gitignore.jpg)
...
![Git Tab in R Studio](/img/2018-05-24-all-about-git-files/git-tab.jpg)

## First Commit

Let's commit our project first. Just click commit and a window should open.

![R Studio's Commit Window](/img/2018-05-24-all-about-git-files/commit-window.jpg)
...
![Project in Repository](/img/2018-05-24-all-about-git-files/new-project-in-repo.jpg)
...
![Add License](/img/2018-05-24-all-about-git-files/license.jpg)
...
![Commit License](/img/2018-05-24-all-about-git-files/commit-license.jpg)
...
![Project with License](/img/2018-05-24-all-about-git-files/updated-project.jpg)

## Create README File

Let's do another push by making a README file using Rmarkdown with output as `github_document`.

![Add README with RMarkdown](/img/2018-05-24-all-about-git-files/README.jpg)

After knitting the README file, we first commit the changes, then push to our repository.

![README in Repository](/img/2018-05-24-all-about-git-files/commit-README.jpg)
